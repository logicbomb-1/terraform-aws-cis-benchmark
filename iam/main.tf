...
data "aws_iam_policy_document" "support_assume_policy" {
  statement {
    principals {
      type        = "AWS"
      identifiers = ["arn:aws:iam::${var.aws_account_id}:root"]
      #identifiers = ["arn:aws:iam::aws:policy/aws-service-role/AWSSupportServiceRolePolicy"]
...
resource "aws_iam_role_policy_attachment" "support_policy" {
  ...
  #policy_arn = "arn:aws:iam::269522862300:role/aws-service-role/support.amazonaws.com/AWSServiceRoleForSupport"
}
